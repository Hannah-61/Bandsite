...
function displayComment(comment) {
    ...
    activityButtons.classList.add('comments__button-activity');

    const likeWrapper = document.createElement('div');
    likeWrapper.classList.add('comments__button-activity-wrapper--like');

    const likeButton = document.createElement('button');
    likeButton.classList.add('comments__button-activity--like');
    ...
    deleteButton.classList.add('comments__button-activity--delete');
